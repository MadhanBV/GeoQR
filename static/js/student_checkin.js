...
/**
 * Requests high-accuracy GPS coordinates from the browser.
 */
function acquireGpsLocation() {
    ...
    gpsStatusSub.textContent = "Locking high-accuracy device location";
    ...
    navigator.geolocation.getCurrentPosition(
        (position) => {
            ...
            // Update UI to Success / Ready State
        ...
        (error) => {
            ...
            if (error.code === error.PERMISSION_DENIED) {
                ...
                message = "GPS signal unavailable. Please ensure location/GPS is turned ON.";
